...
> - [x] <sub> WhatsApp using Baileys. </sub>
> - [x] <sub> Telegram using Telegraf. </sub>
> - [x] <sub> Discord using discord.js. </sub>
...
> - [x] <sub> AI chat using Gemini. </sub>
> - [x] <sub> Media downloader for YouTube, TikTok, Instagram, Facebook, X/Twitter, and Pinterest. </sub>
> - [x] <sub> Group management. </sub>
> - [x] <sub> Moderation tools. </sub>
> - [x] <sub> Sticker maker. </sub>
> - [x] <sub> Utility commands such as ping, calculator, profile, AFK, and more. </sub>
> - [x] <sub> Plugin system with hot-reload support. </sub>
> - [x] <sub> Middleware for cooldown, permission, spam detection, and anti-link. </sub>
> - [x] <sub> CLI support for running selected platforms only. </sub>

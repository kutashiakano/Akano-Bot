...
import { memWatch } from "./system/core/watchdog.js";
import { start as startCleaner } from "./system/core/cleaner.js";
import { startReloadSystem } from "./system/core/reload.js";
import website from "./system/bot/website/index.js";
import database from "./system/database/index.js";

const logErrorPath = path.join(import.meta.dirname, "system", "database", "logerror.json");

const logOldPath = path.join(import.meta.dirname, "system", "database", "logerror.old.json");
...
async function flushDatabaseAndExit(code, signal) {
  ...
  try {
    ...
    try {
      await fs.promises.rm(path.join(import.meta.dirname, "tmp"), {
        recursive: true,
        force: true
      });
    } catch {}

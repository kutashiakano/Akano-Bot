...
const commonMap = [
  [ "Anti", [ "./common/anti", "../whatsapp/lib/anti" ] ],
  [ "Proxy", [ "./common/proxy", "../whatsapp/lib/proxy" ] ],
  [ "Queue", [ "./common/queue", "../whatsapp/lib/queue" ] ],
  [ "Converter", [ "./common/converter", "../whatsapp/lib/converter" ] ],
  [ "Permission", [ "./common/permission", "../whatsapp/lib/permission" ] ]
];

for (const [key, paths] of commonMap) {
  Object.defineProperty(sdk, key, {
    enumerable: true,
    configurable: true,
    get: () => common(paths)
...
for (const [key, paths, pick] of [["Queue", ["./common/queue", "../whatsapp/lib/queue"], "Queue"]]) {
  Object.defineProperty(sdk, key, {
    enumerable: true,
    configurable: true,
    get: () => {
      const m = common(paths);
      return m && m[pick] ? m[pick] : m;
    }
  });
}

...
async function runFfmpeg(args, opts = {}) {
  let heavy = null;
  try {
    const mod = await import("../../../core/heavy.js");
    heavy = mod.default ?? mod;
  } catch {}
...
export { toAudio, toPTT, toVideo, ffmpeg, sticker, addExif, makeExif, isReadableStream, saveStreamToFile, getSpawnEnv, runFfmpeg, runFfprobe, getMediaDuration };
export default {
  toAudio: toAudio,
  toPTT: toPTT,
  toVideo: toVideo,

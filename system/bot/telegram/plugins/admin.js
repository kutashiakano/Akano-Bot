...
module.exports = define({
  ...
  run: async (ctx) => {
    ...
    if (command === "setwelcome") {
      if (!args) {
        return ctx.reply(
          "Error: Please provide a welcome message. Example: /setwelcome Welcome %member% to %subject%!",
        );
      }
    ...
    if (command === "setgoodbye") {
      if (!args) {
        return ctx.reply(
          "Error: Please provide a goodbye message. Example: /setgoodbye Goodbye %member%!",
        );
      }
    ...
    if (command === "setverify") {
      if (!args) {
        return ctx.reply(
          "Error: Please provide a verification message. Example: /setverify Welcome %member%! Please press the Verify button to start chatting.",
        );
      }
    ...
    switch (command) {
      case "welcome":
        ...
        ctx.reply(`Success: Welcome message has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
      ...
      case "goodbye":
        ...
        ctx.reply(`Success: Goodbye message has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
      ...
      case "verification":
        ...
        ctx.reply(`Success: Group verification has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
      ...
      case "antiflood":
        ...
        ctx.reply(`Success: Antiflood has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
      ...
      case "antispam":
        ...
        ctx.reply(`Success: Antispam link blocker has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
      ...
      case "antiarab":
        ...
        ctx.reply(`Success: Antiarab filter has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
      ...
      case "antitagall":
        ...
        ctx.reply(`Success: Antitagall restriction has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
      ...
      case "antiraid":
        ...
        ctx.reply(`Success: Antiraid lockdown has been turned ${mode.toUpperCase()}.`, {
          parse_mode: "HTML",
        });
        break;
    }

const {formatDuration: formatDuration, bar: bar} = require("./utils");
...
module.exports = define({
  ...
  run: async ctx => {
    ...
    const embed = (new EmbedBuilder).setColor("#5865F2").setTitle("Now Playing").setDescription(`[${song.title}](${song.url})`).setThumbnail(song.thumbnail || null).addFields({
      name: "Progress",

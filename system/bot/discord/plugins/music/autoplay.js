...
function normTitle(t) {
  return String(t || "")
    .toLowerCase()
    .replace(/\[.*?\]|\(.*?\)/g, " ")
    .replace(/\b(official video|official audio|official music video|official lyric video|official lyrics|lyrics|audio|video|hd|4k|live)\b/g, " ")
    .replace(/\s+/g, " ")
    .trim();
}

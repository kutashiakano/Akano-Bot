...
const STATE_FILE = path.join(import.meta.dirname, "../../../database/playerState.json");
...
export { STATE_FILE, svState, ldState, ldAllState, clrState };
export default { STATE_FILE, svState, ldState, ldAllState, clrState };
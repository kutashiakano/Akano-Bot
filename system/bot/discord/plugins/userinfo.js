...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .setTitle(`${targetUser.username}${targetUser.discriminator !== "0" ? "#" + targetUser.discriminator : ""}`)
    ...
    if (member) {
      embed.addFields(
        ...
        { name: "Boosting Since", value: member.premiumSince ? `<t:${Math.floor(member.premiumSinceTimestamp / 1000)}:D>` : "Not boosting", inline: true },
    ...
    embed.setFooter({ text: `Requested by ${interaction.user.username}` }).setTimestamp();

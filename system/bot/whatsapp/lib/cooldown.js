...
function matcher(input, commands) {
  const {matcher: m} = require("../../format");
  return m(input, commands);
}

const texted = require("../../format").texted;
...
function socmed(url) {
  const patterns = [ /tiktok\.com/, /instagram\.com/, /facebook\.com/, /fb\.watch/, /twitter\.com/, /x\.com/, /youtube\.com/, /youtu\.be/, /pinterest\.com/, /pin\.it/, /mediafire\.com/ ];

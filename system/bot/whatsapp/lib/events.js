...
import { getQrConfig } from "./socket.js";
import { initSystem, antiDel, delHandler } from "./system-handler.js";

const { DisconnectReason, jidNormalizedUser, getContentType, downloadMediaMessage } = pkg;
const gradient = gradientPkg.default || gradientPkg;

let _wsWatchdog = null;

try {
  const wd = await import("../../../core/watchdog.js");
  _wsWatchdog = wd.default || wd;
} catch {}
      ...
      if (from === "status@broadcast") {
        ...
        if (msg.message.conversation) {
          ...
          if (contentType === "extendedTextMessage") {
            ...
            const filePath = path.join(import.meta.dirname, "../../../..", "tmp", fileName);

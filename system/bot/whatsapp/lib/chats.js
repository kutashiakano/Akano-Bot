const {jidDecode: jidDecode, areJidsSameUser: areJidsSameUser, generateWAMessage: generateWAMessage, proto: proto} = require("baileys");
...
function extendChats(sock, store, ephemeral) {
  ...
  sock.chatRead = async (jid, participant = sock.user.id, messageID) => await sock.sendReadReceipt(jid, participant, [ messageID ]);

let handler = async (m, {sock: sock, args: args, usedPrefix: usedPrefix}) => {
  ...
  const rows = [ {
    title: ". (dot)",
    description: "Use dot prefix",
    id: `${usedPrefix}prefix .`
  }, {
    title: "# (hash)",
    description: "Use hash prefix",
    id: `${usedPrefix}prefix #`
  }, {
    title: "! (exclamation)",
    ...
    title: "/ (slash)",
    description: "Use slash prefix",
    id: `${usedPrefix}prefix /`
  }, {
    title: "None",
    description: "No prefix",
    id: `${usedPrefix}prefix none`
  } ];
  await sock.sendMessage(m.chat, {
    location: {
      name: "PREFIX SETTINGS",
      address: "Bot Configuration",
      jpegThumbnail: null
    },

let handler = async (m, { sock, participants, groupMetadata }) => {
  const pp =
    (await sock.profilePictureUrl(m.chat, "image").catch(() => null)) ||
    "https://files.catbox.moe/ifx2y7.png";
  ...
  await sock.sendFile(m.chat, pp, "pp.jpg", text, m, false, { mentions });
};

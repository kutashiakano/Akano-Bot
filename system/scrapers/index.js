  ...
  async watch() {
    ...
    watcher.on("add", async (file) => {
      ...
      try {
        ...
        console.log(chalk.red.bold(`Gagal load modul ${name}: ${err.message}`));
      }
    });
    ...
    watcher.on("change", async (file) => {
      ...
      try {
        ...
        console.log(chalk.red.bold(`Gagal reload modul ${name}: ${err.message}`));
      }
    });
    ...
    watcher.on("unlink", async (file) => {
      ...
      try {
        ...
        console.log(chalk.red.bold(`Gagal unload modul ${name}: ${err.message}`));
      }
    });
  }
}
